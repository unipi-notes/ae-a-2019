...
\begin{exrc}
	Definire un automa che processa coppia di variabili da k bit e che conta, modulo 2, il numero delle volte che le due variabili in ingresso sono uguali.
...
\begin{exrc}
	...
	\begin{figure}[H]
		...
		\caption{Diagramma di circuito con componenti standard che realizza uno stack di 8 posizioni}
